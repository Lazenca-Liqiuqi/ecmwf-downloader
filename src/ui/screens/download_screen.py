...
class DownloadScreen(BaseScreen):
    ...
    def _load_active_tasks(self) -> None:
        ...
        # 获取下载中和重试中的任务
        downloading_tasks = self.app.progress_manager.get_tasks_by_status(
            TaskStatus.DOWNLOADING
        )
        retrying_tasks = self.app.progress_manager.get_tasks_by_status(
            TaskStatus.RETRYING
        )
